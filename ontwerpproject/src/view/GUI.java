...
/**
 * Quick and dirty debugging gui, prints console to the gui and shows amount of
 * updates etc
 * 
 * @author Jeroen
 *
...
public class GUI {
	...
	public static void main(String[] args) {
		Model mod = new Model();
		try {
			mod.addComponent(new Worker(new InetSocketAddress(
					"192.192.192.192", 123), mod.createConnection(), mod));
	...
	public void updateMetaData() {
		...
		lastcompcon.setText("Last component connected : "
				+ Globals.LAST_COMPONENT);
		amountupdates.setText("Total amount of updates : "
				+ Globals.AMOUNT_UPDATES);
	}
